...
2. Remove the .so files and place them in app/src/main/jniLibs/[ARCH]

3. Zip up the AAR files back into an archive. IMPORTANT: do NOT zip the core-X.Y.Z.aar directory; instead, go *inside* that directory and zip up the files themselves!
