...
var methodsToDelete = [
  ...
  {fileName:"Sound.java", methods:["Sound(SoundData data, ViroContext viroContext, PlaybackListener listener)"]},
  {fileName:"SoundField.java", methods:["SoundField(SoundData data, ViroContext viroContext, PlaybackListener delegate)"]},
  {fileName:"SpatialSound.java", methods:["SpatialSound(SoundData data, ViroContext viroContext, PlaybackListener delegate)"]},
