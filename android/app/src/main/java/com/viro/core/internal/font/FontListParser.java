 ...
 *
 * Viro notes: this class, along with FontConfig and FontVariationAxis, are pulled from AOSP
 * to parse the /system/etc/fonts.xml file, which reads the fonts in /system/fonts and makes
 * them specifiable. In other words, this package makes it possible to convert font families and
 * weights to system fonts.
 *
 * @hide
 */
