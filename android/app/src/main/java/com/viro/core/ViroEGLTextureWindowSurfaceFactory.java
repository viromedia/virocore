...
/**
 * Implementation of {@link GLTextureView.EGLWindowSurfaceFactory} that
 * returns a Viro-compatible surface. Currently this means returning an sRGB-enabled
 * surface.
 *
 * @hide
 */
public class ViroEGLTextureWindowSurfaceFactory implements GLTextureView.EGLWindowSurfaceFactory {
