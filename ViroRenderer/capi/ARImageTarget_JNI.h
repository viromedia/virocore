...
namespace ARImageTarget {
    inline VRO_REF(VROARImageTarget) jptr(std::shared_ptr<VROARImageTarget> target) {
    ...
    inline std::shared_ptr<VROARImageTarget> native(VRO_REF(VROARImageTarget) target_j) {
