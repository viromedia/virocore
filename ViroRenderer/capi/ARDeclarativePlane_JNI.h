...
namespace ARDeclarativePlane {
    inline VRO_REF(VROARDeclarativePlane) jptr(std::shared_ptr<VROARDeclarativePlane> shared_plane) {
    ...
    inline std::shared_ptr<VROARDeclarativePlane> native(VRO_REF(VROARDeclarativePlane) ptr) {
