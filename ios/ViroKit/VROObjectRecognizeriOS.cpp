...
void stillImageDataReleaseCallback2(void *releaseRefCon, const void *baseAddress) {
...
CVPixelBufferRef VROObjectRecognizeriOS::rotateImage(CVPixelBufferRef image, uint8_t rotation,
    ...
    CVPixelBufferCreateWithBytes(NULL,
                                 ...
                                 ubuff.data,
                                 bytesPerRowOut,
                                 stillImageDataReleaseCallback2,
                                 NULL,
                                 NULL,
                                 &rotatedBuffer);
...
CVPixelBufferRef VROObjectRecognizeriOS::convertImage(CVImageBufferRef imageBuffer) {
    ...
    CVPixelBufferCreateWithBytes(kCFAllocatorDefault, width, height, kCVPixelFormatType_32BGRA, rgbBuffer,
                                 width * 4, stillImageDataReleaseCallback2, NULL, NULL, &pixel_buffer);
    return pixel_buffer;
}

void VROObjectRecognizeriOS::writeImageToDisk(CVPixelBufferRef image) {
    CVPixelBufferLockBaseAddress(image, 0);
